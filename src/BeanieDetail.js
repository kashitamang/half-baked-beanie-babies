...
export default function BeanieDetail() {
  ...
  useEffect(() => {
    ...
    //that gets this page's beanie baby and injects it into state using the correct state handler
    ...
    doFetch();
  }, [params.id]); // note that you'll want the id from the url in the dependency array 
  //because you want the useEffect callback to get called every time the url changes 
